...
To use gds-sso in production you will need to setup the following environment variables, which we look for in [the config](lib/gds-sso/config.rb). You will need to have admin access to Signon to get these.
